...
def main() -> None:
    ...
    for cls in (0, 1, 2):
        ...
        print(f"[class {cls}] {len(sub)} unique-composition rows with GWP data")
        ...
        print(f"[class {cls}] R^2 = {r2:.6f}, sigma = {np.sqrt(sigma2):.4f} kg CO2/m^3")
        print(f"[class {cls}] dof = {dof}, n = {n}, d = {d}, rank = {rank}")
